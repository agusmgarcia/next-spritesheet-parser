...
export function useAnimation() {
  const color = useSelector((state) => state.animation.color);
  const fps = useSelector((state) => state.animation.fps);
  const id = useSelector((state) => state.animation.id);
  const index = useSelector((state) => state.animation.index);
  const name = useSelector((state) => state.animation.name);
  const onion = useSelector((state) => state.animation.onion);
  const playing = useSelector((state) => state.animation.playing);
  const sprites = useSelector((state) => state.animation.sprites);

  const animation = useMemo<Animation | undefined>(() => {
    if (!id) return undefined;
    return { color, fps, id, index, name, onion, playing, sprites };
  }, [color, fps, id, index, name, playing, onion, sprites]);
  ...
  return {
    ...
    color: useSelector((state) => state.animation.color),
    ...
    name: useSelector((state) => state.animation.name),
