...
export default function Select(props: SelectProps) {
  ...
  return (
    <select
      {...rest}
      className={twMerge(
        "size-full cursor-pointer appearance-none rounded-lg border border-black bg-white bg-[right_0.25rem_center] bg-no-repeat p-2 text-black outline outline-1 outline-offset-0 outline-transparent",
        "transition-colors",
