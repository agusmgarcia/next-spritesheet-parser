...
export default function Icon(props: IconProps) {
  ...
  switch (variant) {
    case "arrowDown":
      return (
        <svg {...rest}>
          <path d="m11.9999 13.1714 4.9498 -4.94972 1.4142 1.41421 -6.364 6.36401 -6.36391 -6.36401L7.0502 8.22168l4.9497 4.94972Z" />
        </svg>
      );
    ...
    case "forward":
      return (
        <svg {...rest}>
          <path d="M16 12.6667 5.77735 19.4818c-0.22976 0.1531 -0.5402 0.0911 -0.69338 -0.1387C5.02922 19.261 5 19.1645 5 19.0657V4.93426c0 -0.27614 0.22386 -0.5 0.5 -0.5 0.09871 0 0.19522 0.02922 0.27735 0.08397L16 11.3333V5c0 -0.55228 0.4477 -1 1 -1s1 0.44772 1 1v14c0 0.5523 -0.4477 1 -1 1s-1 -0.4477 -1 -1v-6.3333ZM7 7.73703V16.263L13.3944 12 7 7.73703Z" />
        </svg>
      );
    ...
    case "refresh":
      return (
        <svg {...rest}>
          <path d="M5.46257 4.43262C7.21556 2.91688 9.5007 2 12 2c5.5228 0 10 4.47715 10 10 0 2.1361 -0.6698 4.1158 -1.8108 5.7406L17 12h3c0 -4.41828 -3.5817 -8 -8 -8 -2.15018 0 -4.10223 0.84827 -5.53977 2.22842l-0.99766 -1.7958ZM18.5374 19.5674C16.7844 21.0831 14.4993 22 12 22 6.47715 22 2 17.5228 2 12c0 -2.13614 0.66979 -4.11584 1.8108 -5.74056L7 12H4c0 4.4183 3.58172 8 8 8 2.1502 0 4.1022 -0.8483 5.5398 -2.2284l0.9976 1.7958Z" />
        </svg>
      );
    ...
    case "reset":
      return (
        <svg {...rest}>
          <path d="M18.5374 19.5674C16.7844 21.0831 14.4993 22 12 22 6.47715 22 2 17.5228 2 12 2 6.47715 6.47715 2 12 2c5.5228 0 10 4.47715 10 10 0 2.1361 -0.6698 4.1158 -1.8108 5.7406L17 12h3c0 -4.41828 -3.5817 -8 -8 -8 -4.41828 0 -8 3.58172 -8 8 0 4.4183 3.58172 8 8 8 2.1502 0 4.1022 -0.8483 5.5398 -2.2284l0.9976 1.7958Z" />
        </svg>
      );
    ...
    case "zoomIn":
      return (
        <svg {...rest}>
          <path d="m18.031 16.6168 4.2827 4.2827 -1.4142 1.4142 -4.2827 -4.2827C15.0769 19.263 13.124 20 11 20c-4.968 0 -9 -4.032 -9 -9s4.032 -9 9 -9 9 4.032 9 9c0 2.124 -0.737 4.0769 -1.969 5.6168Zm-2.0063 -0.742C17.2475 14.6146 18 12.8956 18 11c0 -3.8675 -3.1325 -7 -7 -7s-7 3.1325 -7 7 3.1325 7 7 7c1.8956 0 3.6146 -0.7525 4.8748 -1.9753l0.1499 -0.1499ZM10 10V7h2v3h3v2h-3v3h-2v-3H7v-2h3Z" />
        </svg>
      );
    ...
    case "zoomOut":
      return (
        <svg {...rest}>
          <path d="m18.031 16.6168 4.2827 4.2827 -1.4142 1.4142 -4.2827 -4.2827C15.0769 19.263 13.124 20 11 20c-4.968 0 -9 -4.032 -9 -9s4.032 -9 9 -9 9 4.032 9 9c0 2.124 -0.737 4.0769 -1.969 5.6168Zm-2.0063 -0.742C17.2475 14.6146 18 12.8956 18 11c0 -3.8675 -3.1325 -7 -7 -7s-7 3.1325 -7 7 3.1325 7 7 7c1.8956 0 3.6146 -0.7525 4.8748 -1.9753l0.1499 -0.1499ZM7 10h8v2H7v-2Z" />
        </svg>
      );
  }
}
