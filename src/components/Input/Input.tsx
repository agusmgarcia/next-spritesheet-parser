...
export default function Input(props: InputProps) {
  ...
  if (rest.type === "color")
    return (
      <input
        {...rest}
        className={twMerge(
          "size-full min-h-[42px] cursor-pointer appearance-none rounded-lg border border-black bg-white p-2 outline-1 outline-offset-0 outline-transparent",
          "transition-colors",
  ...
  if (rest.type === "checkbox")
    return (
      <input
        ...
        className={twMerge(
          "relative",
          "size-[42px] max-h-[42px] max-w-[42px] cursor-pointer appearance-none rounded-lg border-black bg-white p-2 outline-1 outline-offset-0 outline-transparent",
          "transition-colors",
          "focus-within:-outline-offset-2 focus-within:outline-cranberry-600",
    ...
    return (
      <input
        ...
        className={twMerge(
          ...
          "after:absolute after:bottom-full after:translate-x-[var(--translate-x)] after:rounded-t-lg after:bg-black after:px-4 after:text-sm after:opacity-0 after:transition-[opacity,translate] after:content-[attr(value)] hover:after:opacity-100",
  ...
  return (
    <input
      {...rest}
      className={twMerge(
        "size-full min-h-[42px] cursor-text rounded-lg border border-black bg-white p-2 text-black outline-1 outline-offset-0 outline-transparent",
