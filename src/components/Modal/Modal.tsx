...
export default function Modal(props: ModalProps) {
  ...
  return (
    <dialog
      {...dialogProps}
      className={twMerge(
        "m-auto flex max-h-[90vh] w-[380px] translate-y-[calc(100vh+100%)] flex-col overflow-auto rounded-2xl",
    ...
    >
      ...
      {(!!headerProps.children || !!headerProps.onClose) && (
        <div
          className={twMerge(
            "sticky top-0 z-50 flex flex-initial items-center gap-4 p-4 md:px-6 md:pt-6",
